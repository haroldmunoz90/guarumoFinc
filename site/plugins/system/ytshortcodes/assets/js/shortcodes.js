...
jQuery(document).ready(function($) {
	...
	/* Tooltip Block */
	$('.yt-socialbt > a').tooltip({placement:'top'});
...
if(img_src!='') toInject+="<li class='"+classname+"'><a href='#'><img src='"+img_src+"' width='50' alt='' /></a></li>";
else toInject+="<li class='"+classname+"'><a href='#'></a></li>";
};
