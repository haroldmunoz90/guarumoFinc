...
////esto es para que lance el articulo creado con la pagina de error
$article404 = $GLOBALS['article404'];
$root = JUri::root();
$redirect = 'Location: ' . $root . 'index.php?option=com_content&view=article&id='.$article404;
header($redirect);
exit;
