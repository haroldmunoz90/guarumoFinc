...
class PeriodView extends HelperView {
    ...
    function __construct() {
        ...
        $this->assignType("execution_time", JText::_("COM_CTC_SUBCT_EXECUTION_HOUR"), BaseView::TIME, array(BaseView::TOOLTIP => JText::_("COM_CTC_SUBCT_EXECUTION_HOUR_DESC")));
        ...
        $this->addView("table", array("name", "status_id", "period_type", "specific_month_day",
            "specific_week_day", "execution_time", "initial_date", "expiration_date"));
