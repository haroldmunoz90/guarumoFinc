...
class ContractDetailView extends HelperView {
    ...
    function __construct() {
        ...
        $this->assignType("title", "Titulo", BaseView::STRING);
        $this->assignType("content", "Contenido", BaseView::BIG_STRING);
        ...
        $this->addView("table", array("title", "content", "status_id"));
