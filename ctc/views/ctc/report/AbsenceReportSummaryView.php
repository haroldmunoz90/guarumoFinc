...
class AbsenceReportSummaryView extends BaseView {
    ...
    function __construct() {
        ...
        $this->addView("form", array("start_time","end_time",
			"person_id","person_id_ALIAS_1","calendar_time_id",
		...
		$this->addView("formSummary", array ("start_time","end_time",
			"person_id","person_id_ALIAS_2","calendar_time_id",
			"cost_center_id","branch_office_id","area_id","contract_type_id",
			"countDay","hourconcept")); 
		
        $this->addAction("formSummary", "payempldate_report_update", JText::_("COM_CTC_UPDATE"), "save.png");
		
		$this->addView("table", array("person_id","person_id_ALIAS_1", "countDay"));  
